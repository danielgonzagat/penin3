...
class PeninOmegaTestFramework:
    ...
    def __init__(self):
        ...
        self.modules_to_test = [
            ...
            "penin_omega_5_crucible_fixed",
            "penin_omega_8_bridge_fixed"
        ]
    ...
    def test_multi_api_system(self):
        ...
        async def test_multiple_queries():
            ...
            tasks = [
                query_multi_api(f"Query {i}", {"id": i}, "test")
                for i in range(3)
            ]
    ...
    def test_pipeline_integration(self):
        ...
        async def test_crucible_integration():
            ...
            assert result["verdict"] in ["ALLOW", "CANARY", "REJECT"]
            assert "selected_candidates" in result
        
        async def test_bridge_pipeline():
            ...
            assert len(result["stages"]) >= 4  # F3, F4, F5, F6, F8
