...
echo "🚀 Iniciando Sistema Autônomo Executor REAL Qwen2.5-Coder-7B..."
...
mkdir -p /root/qwen_autonomous_executor_checkpoints
mkdir -p /root/qwen_autonomous_executor_sandbox
echo "✅ Diretórios criados"

# Verificar processos anteriores
echo "🔍 Verificando processos anteriores..."
pkill -f "qwen_autonomous_executor.py" 2>/dev/null || true
sleep 2
echo "✅ Processos anteriores finalizados"

# Iniciar sistema autônomo executor
echo "🚀 Iniciando Sistema Autônomo Executor REAL..."
echo ""
echo "🤖 Qwen2.5-Coder-7B - Sistema Autônomo Executor REAL"
echo "   Versão: Autônomo Executor - Zero Simulações"
...
echo "📊 Logs:"
echo "   - Principal: tail -f /root/qwen_autonomous_executor.log"
echo "   - Checkpoints: /root/qwen_autonomous_executor_checkpoints/"
echo "   - Sandbox: /root/qwen_autonomous_executor_sandbox/"
echo ""

# Executar sistema
python3 /root/qwen_autonomous_executor.py
