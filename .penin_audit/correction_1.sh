...
echo "Issue ID: 1"
echo "Timestamp: 2025-09-18T00:10:19.399712"
echo ""
...
LOG LINE: [2025-09-16 18:36:39][PENIN_F3_ACQUISITION][ERROR] F3_ACQUISITION is already running
...
This is issue ID 1 - please mark it as RESOLVED when fixed."
echo ""
