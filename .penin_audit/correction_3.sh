...
echo "Issue ID: 3"
echo "Timestamp: 2025-09-18T00:10:19.411306"
echo ""
...
LOG LINE: [2025-09-16 18:38:07][PENIN_F3_ACQUISITION][ERROR] F3_ACQUISITION is already running
...
This is issue ID 3 - please mark it as RESOLVED when fixed."
echo ""
