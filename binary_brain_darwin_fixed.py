        ...
        try:
            ...
            for nid, data in neurons_data.items():
                ...
                entity = NeuronEntity(
                    ...
                    hemisphere=data.get('hemisphere', random.choice(['left', 'right'])),
                ...
                entity.fitness = data.get('fitness', random.uniform(0.4, 0.8))
                entity.logic_score = data.get('logic_score', random.random())
                entity.creativity_score = data.get('creativity_score', random.random())
