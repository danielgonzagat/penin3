...
class EmergenceDetector:
    ...
    async def _collect_emergence_signals(self):
        ...
        for source in signal_sources:
            ...
            if deterministic_random() < 0.1:  # 10% chance de sinal
                signal_type = deterministic_choice(list(EmergenceType))
                signal_strength = deterministic_random()
...
if __name__ == "__main__":
    ...
    for i in range(200):
        signal_type = deterministic_choice(signal_types)
        signal_strength = deterministic_random()
        signal_source = deterministic_choice(sources)
